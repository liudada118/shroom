const DEVICE_MATRIX_CONFIG = Object.freeze({
  ...
  'endi-jacket': { pointWidthDistance: 12.5, pointHeightDistance: 12.5, width: 24, height: 54 },
  'endi-leftHand': { pointWidthDistance: 12.5, pointHeightDistance: 12.5, width: 36, height: 4 },
  'endi-rightHand': { pointWidthDistance: 12.5, pointHeightDistance: 12.5, width: 36, height: 4 },
  'endi-leftFoot': { pointWidthDistance: 12.5, pointHeightDistance: 12.5, width: 12, height: 64 },
  'endi-rightFoot': { pointWidthDistance: 12.5, pointHeightDistance: 12.5, width: 12, height: 64 },
  'endi-foot': { pointWidthDistance: 12.5, pointHeightDistance: 12.5, width: 24, height: 64 },
