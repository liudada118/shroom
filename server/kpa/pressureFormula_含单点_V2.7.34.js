...
// =====================================================================
// 坐垫砝码段（9段，X轴=TOP-70均值，范围[92.780,186.200]）
// =====================================================================
const SEAT_SEGS = [
  ...
  { lo: 184.45, hi: 186.2, a: 0.2442373, b: -89.06465, c: 8141.050891 },
];

// =====================================================================
// 靠背砝码段（9段，X轴=TOP-46均值，范围[125.610,206.466]）
...
const BACK_SEGS = [
  ...
  { lo: 204.608, hi: 206.466, a: 0.1379828, b: -55.36561, c: 5574.167655 },
];

// 端点参数
const SEAT_LEFT_SLOPE = 2.64748071e-02;
const SEAT_P_HI = 25.02771641;
const SEAT_RIGHT_SLOPE = 1.88932052;
const BACK_LEFT_SLOPE = 1.95092216e-02;
const BACK_P_HI = 25.01127907;
const BACK_RIGHT_SLOPE = 1.61190357;
