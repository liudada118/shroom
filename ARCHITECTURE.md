...
> 本文档由 Manus 自动生成和维护。最后更新于：2026-03-11 22:24
...
| 2026-03-11 | 座椅动画流畅度优化 | 所有3D组件 changeCamera 添加 easeOutCubic 缓动动画，ViewSetting 加减按钮支持长按连续缩放，步长更细腻，按钮添加视觉反馈 |
...
| 2026-03-11 22:24 | ani | 优化重构 | 优化座椅模型缩放动画流畅度：所有3D组件 changeCamera 添加 200ms easeOutCubic 缓动动画；ViewSetting 加减按钮支持长按连续缩放（300ms 启动，80ms 间隔）；缩放步长更细腻（2/3/5/10/20/50）；按钮添加 hover/active 视觉反馈 |
