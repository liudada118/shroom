 ...
 *   2. VITE_API_PORT / VITE_WS_PORT  —— 开发模式下由 Electron 主进程通过环境变量传入
...
function getApiPort() {
  ...
  if (import.meta.env.VITE_API_PORT) {
    return parseInt(import.meta.env.VITE_API_PORT, 10)
  }
  // 默认值
...
function getWsPort() {
  ...
  if (import.meta.env.VITE_WS_PORT) {
    return parseInt(import.meta.env.VITE_WS_PORT, 10)
  }
