  ...
  resources: {
    en: {
      translation: {
        ...
        symmetryCoefficient: 'Symmetry Coefficient',
        ...
        paramHeight: 'Size Adjustment',
        paramHeightDesc: 'Point size scaling factor for the 3D/WebGL view.',
        ...
        selectionTipLimit: 'Up to {{count}} selections, X + Length <= {{width}}, Y + Width <= {{height}}',
        ...
        seatPad: 'Seat',
        backPad: 'Back',
        jacketPad: 'Upper body',
        leftHandPad: 'Left arm',
        rightHandPad: 'Right arm',
        leftFootPad: 'Left leg',
        rightFootPad: 'Right leg',
        footPad: 'Lower body',
        jacket2D: 'Upper body',
        leftHand2D: 'Left arm',
        rightHand2D: 'Right arm',
        leftFoot2D: 'Left leg',
        rightFoot2D: 'Right leg',
        foot2D: 'Lower body',
    ...
    zh: {
      translation: {
        ...
        paramHeight: '大小调节',
        paramHeightDesc: '3D/WebGL 视图中数据点的大小缩放系数',
        paramCoherent: '响应速度',
        ...
        selectionTipLimit: '最多{{count}}个框选，X+长 ≤ {{width}}，Y+宽 ≤ {{height}}',
