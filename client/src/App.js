  ...
  resources: {
    en: {
      translation: {
        ...
        adjust: 'Adjust',
        blur: 'GaussianBlur',
        threeGaussian: '3D Gaussian Blur',
        threeTemporal: '3D Frame Smoothing',
        threeDisplayData: '3D / Chart Data',
        adcCurve: 'Total ADC Curve',
        adcAverage: 'Average ADC',
        adcMax: 'Maximum ADC',
        adcTotal: 'Total ADC',
        adcCenter: 'ADC Centroid',
        threeRawAdc: 'Raw ADC',
        threePressure: 'kPa',
        threeForce: 'N',
        colorAdj: 'ColorAdj',
        ...
        forceCurve: 'Total Force Curve',
        forceAver: 'Average Force',
        forceMax: 'Maximum Force',
        forceTotal: 'Total Force',
        pressureSum: 'Total Pressure',
        forceTotalAxis: 'Total Force (N)',
        pressureSumAxis: 'Total Pressure (kPa)',
        switchPressureMetric: 'Switch pressure / force',
        ...
        exportFieldsLoadFailed: 'Failed to load export fields. Default fields are being used.',
        selectExportFields: 'Please select at least one export field',
        browse: 'Browse',
        ...
        paramCoherentDesc: 'Legacy collection parameter retained for compatibility. Temporal smoothing is disabled.',
        ...
        saveSelectionPrompt: 'Save the current selection as a template?',
        modifiedAppliedTemplatePrompt: 'The applied template has been modified. Overwrite it or save as a new template?',
        saveAsNewTemplate: 'Save as new',
        overwriteOriginalTemplate: 'Overwrite original',
        dontSave: 'Don\'t save',
        ...
        collectingProcessingLocked: 'Filter settings are locked while collecting. Stop collection first.',
    ...
    zh: {
      translation: {
        ...
        adjust: '可视化调节',
        blur: '图像润滑',
        threeGaussian: '3D 高斯平滑',
        threeTemporal: '3D 跨帧平滑',
        threeDisplayData: '3D / 图表数据',
        adcCurve: 'ADC总和曲线',
        adcAverage: '平均ADC',
        adcMax: '最大ADC',
        adcTotal: 'ADC总和',
        ...
        pointsAxis: '点数(个)',
        pressureCurve: '压强总和曲线',
        forceCurve: '压力总和曲线',
        forceAver: '平均压力',
        forceMax: '最大压力',
        forceTotal: '压力总和',
        pressureSum: '压强总和',
        forceTotalAxis: '压力总和(N)',
        pressureSumAxis: '压强总和(kPa)',
        switchPressureMetric: '切换压强/压力',
        areaCurve: '面积曲线',
        speed: '倍速',
        dataCollect: '数据采集',
        ...
        exportFormat: '导出格式',
        exportFields: '导出字段',
        exportFieldsLoadFailed: '导出字段读取失败，已使用默认字段',
        selectExportFields: '请至少选择一个导出字段',
        browse: '浏览',
        selectedCount: '已选择',
        items: '项',
        downloading: '正在下载...',
        ...
        paramCoherent: '响应速度',
        paramCoherentDesc: '兼容旧采集配置保留的参数，当前不再执行帧间时序平滑',
        ...
        exitSelectionTitle: '退出框选',
        saveSelectionPrompt: '是否需要将当前框选保存为模板？',
        modifiedAppliedTemplatePrompt: '已应用的模板发生修改，请选择覆盖旧模板或另存为新模板。',
        saveAsNewTemplate: '另存为新模板',
        overwriteOriginalTemplate: '覆盖旧模板',
        dontSave: '不保存',
        ...
        collectingProcessingLocked: '采集中已锁定滤波参数，请停止采集后再修改',
