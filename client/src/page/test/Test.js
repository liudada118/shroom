...
function Test() {
    ...
    const setValueData = localStorage.getItem('setValueData') ? JSON.parse(localStorage.getItem('setValueData')) : { gauss: 2, color: 180, filter: 10, height: 80, coherent: 1, autoColor: 1 }
