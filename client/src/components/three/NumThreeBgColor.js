    ...
    useEffect(() => {
      ...
      `,
        ...
        void main() {
            ...
            vec3 bgColor = vec3(1.0, 0.0, 0.0);  // 🔴 静态红色背景
      ...
      `,
        ...
        function animate() {
            ...
            for (let i = 0; i < count; i++) {
                ...
                geometry.setAttribute("instanceBgColor", new THREE.InstancedBufferAttribute(colorArray, 3));
                  geometry.attributes.instanceBgColor.needsUpdate = true;
