const length32Arr = ['hand', 'bed', 'sit', 'back', 'jacket', 'leftHand', 'rightHand', 'leftFoot', 'rightFoot', 'foot']
const length64Arr = []
...
export const optimalObj = {
  bed: { gauss: 2, color: 5, filter: 0, height: 80, coherent: 1, autoColor: 1 },
  car: { gauss: 2, color: 5, filter: 0, height: 80, coherent: 1, autoColor: 1 },
  endi: { gauss: 2, color: 5, filter: 0, height: 80, coherent: 1, autoColor: 1 },
  carY: { gauss: 2, color: 5, filter: 0, height: 80, coherent: 1, autoColor: 1 },
  bigHand: { gauss: 2, color: 5, filter: 0, height: 80, coherent: 1, autoColor: 1 },
  hand: { gauss: 2, color: 5, filter: 0, height: 80, coherent: 1, autoColor: 1 }
};
